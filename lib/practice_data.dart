import 'package:naver_map/custom_class/location_class.dart';
...
class PracticeData {
  static final List<StoreType> myStores = [
    Cafe(
      ...
      storeName: "리틀빅토리",
      location:
          LocationClass(latitude: 37.611686857721, longitude: 127.00379921348),
    ),
    Cafe(
    ...
    Restaurant(
      ...
      detailInfo:
          "설명 미쁘동은 단맛과 찰기가 우수한 고시히카리 품종으로 밥을 짓고 매일 아침 성게알을 비롯한 신선한 해산물을 받아 손질합니다. 또한 양질의 가다랑어포 등을 넣어 끓인 전통 방식 간장을 곁들여 식탁 위 그릇에 건강함을 담았습니다.",
    ...
    Restaurant(
      ...
      uid: "4",
      detailInfo:
          "연남동에 위치한 유러피안 비스트로 수부니흐입니다. 수부니흐는 souvenir의 프랑스 발음으로 추억, 기억이라는 뜻을 가진 이름입니다. 그만큼 방문하시는 모든분들이 좋은 추억과 기억을 가지고 가실수있도록 최선을 다하겠습니다.",
      storeName: "수브니흐",
